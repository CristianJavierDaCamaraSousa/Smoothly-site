# Smoothly End User License Agreement (EULA)

**Last updated:** June 2026

This agreement is between you and the Smoothly software author ("Licensor") for the Smoothly application ("Software").
...
Updates may be delivered via the public Smoothly website. Licensor is not obligated to provide updates but may do so at their discretion.

## 5. Disclaimer

THE SOFTWARE IS PROVIDED "AS IS" WITHOUT WARRANTY OF ANY KIND. LICENSOR DISCLAIMS ALL WARRANTIES, INCLUDING MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE.
...
This license ends if you breach these terms. Upon termination, you must stop using the Software and delete all copies.
